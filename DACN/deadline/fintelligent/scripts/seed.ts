...
const SEED_USER_ID = "user_2pZ7ohWWhSU5M2rXuK4xOMEVqBD"
const SEED_CATEGORIES = [
    { id: "category_1", name: "Food", userId: SEED_USER_ID, plaidId: null},
    { id: "category_2", name: "Rend", userId: SEED_USER_ID, plaidId: null},
    ...
    { id: "category_8", name: "Transportation", userId: SEED_USER_ID, plaidId: null},
...
const main = async () => {
    try {
        ...
        console.error("Error duiring seed:", error)
        process.exit(1)
    }
}
